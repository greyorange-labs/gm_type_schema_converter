            ...
            {type, 0, tuple, [
                ...
                {type, 0, map, [
                    ...
                    {type, 0, map_field_assoc, [
                        {atom, 0, pattern}, {bin, 0, [{bin_element, 0, {string, 0, "^[a-zA-Z0-9_-]+$"}, default, default}]}
                    ]}
                ]}
            ]}},
    Schema = gm_type_schema_converter:type_to_schema(TypeDef, []),
    ...
    TypeDef =
        {email,
            {type, 0, tuple, [
                ...
                {type, 0, map, [
                    {type, 0, map_field_assoc, [
                        {atom, 0, format}, {bin, 0, [{bin_element, 0, {string, 0, "email"}, default, default}]}
                    ]}
                ]}
            ]}},
    Schema = gm_type_schema_converter:type_to_schema(TypeDef, []),
            ...
            {type, 1, tuple, [
                ...
                {type, 1, map, [
                    {type, 1, map_field_assoc, [
                        {atom, 1, description},
                        {bin, 1, [{bin_element, 1, {string, 1, "Unique user identifier"}, default, default}]}
                    ]}
                ]},
                {type, 1, binary, []}
            ]}},
    ...
    TypeDef =
        {user_id,
            {type, 1, tuple, [
                ...
                {type, 1, map, [
                    {type, 1, map_field_assoc, [
                        {atom, 1, description}, {bin, 1, [{bin_element, 1, {string, 1, "User ID"}, default, default}]}
                    ]},
                    {type, 1, map_field_assoc, [
                        {atom, 1, example}, {bin, 1, [{bin_element, 1, {string, 1, "usr_abc123"}, default, default}]}
                    ]},
    ...
    TypeDef =
        {x,
            {type, 1, tuple, [
                ...
                {type, 1, map, [
                    {type, 1, map_field_assoc, [
                        {atom, 1, title}, {bin, 1, [{bin_element, 1, {string, 1, "My Title"}, default, default}]}
                    ]}
                ]},
                {type, 1, integer, []}
            ]}},
        ...
        {x,
            {type, 1, tuple, [
                ...
                {type, 1, map, [
                    ...
                    {type, 1, map_field_assoc, [
                        {atom, 1, description}, {bin, 1, [{bin_element, 1, {string, 1, "Read-only field"}, default, default}]}
                    ]}
                ]},
                {type, 1, binary, []}
            ]}},
    ...
    TypeDef =
        {payment,
            {type, 1, tuple, [
                ...
                {atom, 1, type},
                {cons, 1, {user_type, 1, credit_card, []}, {cons, 1, {user_type, 1, paypal, []}, {nil, 1}}}
            ]}},
    Schema = gm_type_schema_converter:type_to_schema(TypeDef, AllTypes),
